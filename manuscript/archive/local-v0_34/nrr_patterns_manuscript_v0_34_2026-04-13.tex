...
interpretive control. Its role is to answer the reviewer question: are the
observed gains just generic prompt compression? The comparison is recorded in
...
needed to keep the comparison honest. In the current package, the selected
